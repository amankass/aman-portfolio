  ...
  return (
    <section id='skills'>
      ...
      <div className="skillBars">
        ...
        <div className="skillBar">
          <img src={Contentcreation} alt="Content Creator" className="skillBarImg" />
          <div className="skillBarText">
        ...
        <div className="skillBar">
          <img src={graphicsdesign} alt="Graphics Design" className="skillBarImg" />
          <div className="skillBarText">
            <h2>Graphics Design</h2>
            <p>
              I create visually appealing designs that communicate brand identity and
              captivate audiences.
            </p>
          </div>
        </div>
